...
float float2::operator[](int i) const
{
    if (i == 0)
        return x;
    else if (i == 1)
        ...
        CV_Error(CV_StsNotImplemented, "index out of data, in float2!");
}
...
float float3::operator[](int i) const
{
    if (i == 0)
        ...
        CV_Error(CV_StsNotImplemented, "index out of data, in float3!");
}
...
float float4::operator[](int i) const
{
    if (i == 0)
        ...
        CV_Error(CV_StsNotImplemented, "index out of data, in float4!");
}
